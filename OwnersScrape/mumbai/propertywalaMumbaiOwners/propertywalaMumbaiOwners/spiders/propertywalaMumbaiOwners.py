# -*- coding: utf-8 -*-
import scrapy
from ..items import PropertywalamumbaiownersItem
...
class PropertyhousesforpunesaleSpider(scrapy.Spider):
    ...
    custom_settings = {
        # 'AWS_ACCESS_KEY_ID': 'AKIAJVIBA7SDMWY4QSEQ',
        # 'AWS_SECRET_ACCESS_KEY': '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',
        'ITEM_PIPELINES': {'propertywalaMumbaiOwners.pipelines.MyImagesPipeline': 1, },
        'IMAGES_STORE': './Owners_Images',
        # 'FEED_FORMAT': 'csv',
        # 'FEED_URI': 's3://oyeok-s3/owners/%(name)s/%(time)s.csv',
        'DEPTH_LIMIT': 10000,
        'DOWNLOAD_DELAY': 10.0,
