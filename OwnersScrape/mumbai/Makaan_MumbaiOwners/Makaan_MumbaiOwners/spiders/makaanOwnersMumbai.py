...
class MakaansalepuneSpider(scrapy.Spider):
    name = "makaanMumbaiOwners"
    allowed_domains = ["makaan.com"]
    start_urls = [
        'https://www.makaan.com/listings?postedBy=owner&sortBy=date-desc&listingType=buy&pageType=LISTINGS_PROPERTY_URLS&cityName=Mumbai&cityId=18&templateId=MAKAAN_CITY_LISTING_BUY&page=1',
        'https://www.makaan.com/listings?postedBy=owner&sortBy=date-desc&listingType=rent&pageType=LISTINGS_PROPERTY_URLS&cityName=Mumbai&cityId=18&templateId=MAKAAN_CITY_LISTING_BUY&page=1'
        # 'https://www.makaan.com/listings?postedBy=owner&sortBy=date-desc&listingType=buy&pageType=LISTINGS_PROPERTY_URLS&cityName=Mumbai&suburbName=navi%20mumbai&cityId=18&suburbId=10045&templateId=MAKAAN_SUBURB_LISTING_BUY&format=json&page=1',
        # 'https://www.makaan.com/listings?postedBy=owner&sortBy=date-desc&listingType=rent&pageType=LISTINGS_PROPERTY_URLS&cityName=Mumbai&suburbName=navi%20mumbai&cityId=18&suburbId=10045&templateId=MAKAAN_SUBURB_LISTING_BUY&format=json&page=1',
        # 'https://www.makaan.com/listings?postedBy=owner&sortBy=date-desc&listingType=buy&pageType=LISTINGS_PROPERTY_URLS&cityName=Mumbai&suburbName=thane&cityId=18&suburbId=10048&templateId=MAKAAN_SUBURB_LISTING_BUY&format=json&page=1',
        # 'https://www.makaan.com/listings?postedBy=owner&sortBy=date-desc&listingType=rent&pageType=LISTINGS_PROPERTY_URLS&cityName=Mumbai&suburbName=thane&cityId=18&suburbId=10048&templateId=MAKAAN_SUBURB_LISTING_BUY&format=json&page=1',
    ]
    custom_settings = {
        # 'ITEM_PIPELINES': {'Makaan_MumbaiOwners.pipelines.MyImagesPipeline': 1, },
        # 'IMAGES_STORE': './Property_Images',
        'DEPTH_LIMIT': 10000,
        'DOWNLOAD_DELAY': 5.0,
    }
