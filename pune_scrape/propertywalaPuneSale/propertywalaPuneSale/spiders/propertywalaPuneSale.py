...
class PropertyhousesforpunesaleSpider(scrapy.Spider):
    name = "propertywalaSalePune"
    allowed_domains = ["propertywala.com"]
    start_urls = (
        'https://www.propertywala.com/properties/type-residential_apartment_flat/for-sale/location-pune_maharashtra?page=%s' % page for page in range(1, 41)
    )
    custom_settings = {
        'DEPTH_LIMIT': 10000,
        'DOWNLOAD_DELAY': 1}
