...
class PropertywalasaleSpider(scrapy.Spider):
    name = "propertywalaSalePune_House"
    allowed_domains = ["propertywala.com"]
    start_urls = (
        'https://www.propertywala.com/properties/type-residential_independent_house/for-sale/location-pune_maharashtra?page=%s'% page for page in range(1, 11)
    )
    custom_settings = {
        'DEPTH_LIMIT': 10000,
        'DOWNLOAD_DELAY': 1}
