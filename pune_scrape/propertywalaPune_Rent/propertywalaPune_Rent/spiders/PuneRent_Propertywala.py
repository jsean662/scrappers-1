...
import re
from ..items import PropertywalapuneRentItem
from datetime import datetime as dt
from dateutil.relativedelta import relativedelta


class PunerentPropertywalaSpider(scrapy.Spider):
    name = "propertywalaRentPune"
    allowed_domains = ["propertywala.com"]
    start_urls = (
        'https://www.propertywala.com/properties/type-residential/for-rent/location-pune_maharashtra?page=%s' % page for page in range(1, 41)
    )
    custom_settings = {
        'DEPTH_LIMIT': 10000,
        'DOWNLOAD_DELAY': 1}
    item = PropertywalapuneRentItem()
    # d = ""
    # name_lister = ""
    maxPage = 40
    ...
    #   max_page = int(response.xpath('//*[@id="propertyList"]/div[1]/div[3]/a[6]/@href').extract_first().split('=')[1])
        ...
        for i in data:
            ...
            #  nexch_data = " nexch_data Broker" + " nme ABC XYZ"
    ...
    def parse1(self, response):
        ...
        if 'plot' in checkprop or 'land' in checkprop:
            pass
        else:
