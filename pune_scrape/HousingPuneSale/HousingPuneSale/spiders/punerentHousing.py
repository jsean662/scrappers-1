# -*- coding: utf-8 -*-
import scrapy
from ..items import HousingpunerentItem
import json
...
class PunerenthousingSpider(scrapy.Spider):
    name = "housingSalePune"
    allowed_domains = ["housing.com"]
    start_urls = (
        'https://buy.housing.com//api/v3/buy/index/filter?source=web&poly=eec306948307d1a640ac&sort_key=date_added&np_offset=0&negative_aggregation={}&show_collections=true&show_aggregations=true&placeholder_ids=2,3,6,7&p=%s' % page for page in range(1, 1478)
    )
    custom_settings = {
        'DEPTH_LIMIT': 5000,
        'DOWNLOAD_DELAY': 3,
