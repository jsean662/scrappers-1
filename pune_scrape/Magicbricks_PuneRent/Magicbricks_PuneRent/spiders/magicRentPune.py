...
class MagicrentspiderhyderabadSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        try:
            ...
            #     if pageNo < pagecount:
            #         url = 'http://www.magicbricks.com/property-for-rent/residential-real-estate?proptype=Multistorey-Apartment,Builder-Floor-Apartment,Penthouse,Studio-Apartment,Service-Apartment,Residential-House,Villa&cityName=Pune&sortBy=mostRecent/Page-' + str(pageNo + 1)
            #         # print(url)
