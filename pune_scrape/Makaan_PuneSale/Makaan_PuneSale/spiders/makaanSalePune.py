...
<<<<<<< HEAD
    ...
    start_urls = [
        'https://www.makaan.com/listings?sortBy=date-desc&listingType=buy&pageType=LISTINGS_PROPERTY_URLS&cityName=Pune&cityId=21&templateId=MAKAAN_CITY_LISTING_BUY&format=json&page=1',
        'https://www.makaan.com/listings?sortBy=date-desc&listingType=rent&pageType=LISTINGS_PROPERTY_URLS&cityName=Pune&cityId=21&templateId=MAKAAN_CITY_LISTING_BUY&format=json&page=1',
=======
    name = "makaanSalePune"
    allowed_domains = ["makaan.com"]
    start_urls = [
        'https://www.makaan.com/listings?sortBy=date-desc&listingType=buy&pageType=CITY_URLS&cityName=Pune&cityId=21&templateId=MAKAAN_CITY_LISTING_BUY&page=1',
        # % page for page in range(1, 10)
...
=======
                ...
                try:
                    ...
                    if pages is not None:
                        ...
                        totalpages = pages['totalPages']
                        if pageno < totalpages:
                            url = 'https://www.makaan.com/listings?sortBy=date-desc&listingType=buy&pageType=CITY_URLS&cityName=Pune&cityId=21&templateId=MAKAAN_CITY_LISTING_BUY&page=' + str(pageno+1)
