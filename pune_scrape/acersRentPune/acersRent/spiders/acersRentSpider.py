...
import scrapy
from acersRent.items import AcersrentItem
...
class AcersrentspiderSpider(scrapy.Spider):
    name = "acersRentPune"
    allowed_domains = ["http://www.99acres.com"]
    start_urls = ['http://www.99acres.com/rent-property-in-pune-ffid-page-%s?orig_property_type=1,4,2,90&search_type=QS&search_location=CP12&lstacn=SEARCH&pageid=QS&src=PAGING&property_type=1,4,2,90/'% page for page in xrange(1,615)]
    custom_settings = {
            'DEPTH_LIMIT': 3000,
            'DOWNLOAD_DELAY': 10
        }
