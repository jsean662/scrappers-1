import scrapy
import logging
from commonFRentPune.items import CommonfrentpuneItem
...
class CommonfloorrentpuneSpider(scrapy.Spider):
    name = "commonFloorRentPune"
    allowed_domains = ["https://www.commonfloor.com"]
    start_urls = ['https://www.commonfloor.com/listing-search?city=Pune&prop_name[]=&property_location_filter[]=&use_pp=0&set_pp=1&polygon=1&page_size=30&search_intent=rent&min_inr=&max_inr=&page=1']
    ...
    def parse(self,response):
        ...
        if curPage < maxPage:
            nexturl = 'https://www.commonfloor.com/listing-search?city=Pune&prop_name[]=&property_location_filter[]=&use_pp=0&set_pp=1&polygon=1&page_size=30&search_intent=sale&min_inr=&max_inr=&page={}'.format(str(curPage+1))
