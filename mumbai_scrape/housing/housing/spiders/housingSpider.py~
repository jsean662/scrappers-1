...
class HousingSpider(scrapy.Spider):
    ...
    start_urls = ['https://buy.housing.com/api/v1/buy/index/filter?placeholder_ids=6,2,3,7&sort_key=relevance&poly=63913984110fb4e5c0b4&results_per_page=20&show_collections=true&show_aggregations=true&np_total_count=80&resale_total_count=1635&np_offset=0&resale_offset=-2&p=1']
