...
class PropertywalamumbaiSpider(scrapy.Spider):
    name = "propertywalaMumbaiCommercial"
    allowed_domains = ["propertywala.com"]
    start_urls = [
        'https://www.propertywala.com/properties/type-commercial_office_space/for-sale/location-mumbai_maharashtra?orderby=date',
        'https://www.propertywala.com/properties/type-commercial_office_space/for-rent/location-mumbai_maharashtra?orderby=date',
    ]
    custom_settings = {
        'DEPTH_LIMIT': 10000,
        'DOWNLOAD_DELAY': 5.0,
