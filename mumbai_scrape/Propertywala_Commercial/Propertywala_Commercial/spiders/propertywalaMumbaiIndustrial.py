...
class PropertywalamumbaiSpider(scrapy.Spider):
    name = "propertywalaMumbaiIndustrial"
    allowed_domains = ["propertywala.com"]
    start_urls = [
        'https://www.propertywala.com/properties/type-commercial_warehouse_godown/for-sale/location-mumbai_maharashtra?orderby=date',
        'https://www.propertywala.com/properties/type-commercial_warehouse_godown/for-rent/location-mumbai_maharashtra?orderby=date',
    ]
    custom_settings = {
        'DEPTH_LIMIT': 10000,
        'DOWNLOAD_DELAY': 5.0,
    ...
    def parse1(self, response):
        ...
        if 'arehouse' in conf or 'odown' in conf:
            self.item['property_type'] = 'Industrial'
