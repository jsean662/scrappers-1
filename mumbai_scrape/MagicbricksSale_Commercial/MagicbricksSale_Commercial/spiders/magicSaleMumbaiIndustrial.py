...
class MagicsalemumbaiSpider(scrapy.Spider):
    ...
    def parse(self, response):
        try:
            ...
            for i in data:
                try:
                    ...
                    proptype = i.xpath('.//input[contains(@id,"propertyVal")]/@value').extract()
        ...
        if 'resultBlockWrapper' in str(response.body):
            ...
            url = 'http://www.magicbricks.com/property-for-sale/commercial-real-estate?proptype=Warehouse/-Godown&cityName=Mumbai&sortBy=mostRecent/Page-' + str(pageno + 1)
            # print(url)
            ...
            # else:
            #     if pageNo < pagecount:
            #         url = 'http://www.magicbricks.com/property-for-sale/commercial-real-estate?proptype=Warehouse/-Godown&cityName=Mumbai&sortBy=mostRecent/Page-1' + str(pageNo + 1)
            #         # print(url)
