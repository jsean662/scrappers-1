...
class MagicrentmumbaiSpider(scrapy.Spider):
    name = "magicRentMumbaiCommercial"
    allowed_domains = ["magicbricks.com"]
    start_urls = [
        'http://www.magicbricks.com/property-for-rent/commercial-real-estate?proptype=Commercial-Office-Space,Office-ITPark-SEZ&cityName=Mumbai&sortBy=mostRecent/Page-1',
    ]
    custom_settings = {
        'DEPTH_LIMIT': 10000,
        'DOWNLOAD_DELAY': 5.0,
    ...
    def parse(self, response):
        ...
        try:
            ...
            #     if pageNo < pagecount:
            #         url = 'http://www.magicbricks.com/property-for-rent/commercial-real-estate?proptype=Commercial-Office-Space,Office-ITPark-SEZ&cityName=Mumbai&sortBy=mostRecent/Page-' + str(pageNo + 1)
            #         # print(url)
