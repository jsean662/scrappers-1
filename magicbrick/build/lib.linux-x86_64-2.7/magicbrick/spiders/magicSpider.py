	...
	def parse(self,response):
			...
			if ('pagination' in str(response.body)):
				...
				for i in data:
					...
					try:
						sqft_per = i.xpath('div[@class="proColmRight"]/div[@class="proPriceColm2"]/div[@class="proPriceColm2"]/div[@class="sqrPrice"]/span[@class="sqrPriceField"]/text()').extract_first()
