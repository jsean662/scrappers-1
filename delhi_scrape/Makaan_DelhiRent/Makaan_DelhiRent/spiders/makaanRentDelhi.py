...
class MakaanrentdelhiSpider(scrapy.Spider):
    ...
    start_urls = (
        'https://www.makaan.com/listings?listingType=rent&pageType=CITY_URLS&cityName=Delhi&cityId=6&templateId=MAKAAN_CITY_LISTING_BUY&page=%s' % page for page in range(1, 470)
    )
    custom_settings = {
        'DEPTH_LIMIT': 5000,
        'DOWNLOAD_DELAY': 3,
