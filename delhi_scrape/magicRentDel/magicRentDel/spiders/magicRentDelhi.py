...
<<<<<<< HEAD
=======
        # % page for page in range(575, 585)
...
=======
            ...
            #     if pageNo < pagecount:
            #         url = 'http://www.magicbricks.com/property-for-rent/residential-real-estate?proptype=Multistorey-Apartment,Builder-Floor-Apartment,Penthouse,Studio-Apartment,Service-Apartment,Residential-House,Villa&cityName=Delhi-NCR&sortBy=mostRecent/Page-' + str(pageNo + 1)
            #         # print(url)
