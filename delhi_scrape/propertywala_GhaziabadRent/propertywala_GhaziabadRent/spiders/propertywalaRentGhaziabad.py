# -*- coding: utf-8 -*-
import scrapy
from ..items import PropertywalaGhaziabadrentItem
...
class PropertywalarentghaziabadSpider(scrapy.Spider):
    name = "propertywalaRentGhaziabad"
    allowed_domains = ["propertywala.com"]
    start_urls = [
        'https://www.propertywala.com/properties/type-residential/for-rent/location-ghaziabad_uttar_pradesh/',
    ]
    custom_settings = {
        'DEPTH_LIMIT': 10000,
        'DOWNLOAD_DELAY': 1}
    item = PropertywalaGhaziabadrentItem()
