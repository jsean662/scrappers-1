# -*- coding: utf-8 -*-
import scrapy
from ..items import PropertywalaFaridabadrentItem
...
class PropertywalarentfaridabadSpider(scrapy.Spider):
    name = "propertywalaRentFaridabad"
    allowed_domains = ["propertywala.com"]
    start_urls = [
        'https://www.propertywala.com/properties/type-residential/for-rent/location-faridabad_haryana?page=%s' % page for page in range(1, 7)
    ]
    custom_settings = {
        'DEPTH_LIMIT': 10000,
        'DOWNLOAD_DELAY': 1}
    item = PropertywalaFaridabadrentItem()
    ...
    def parse1(self, response):
        ...
        if 'plot' in checkprop.lower() or 'land' in checkprop.lower():
            ...
            if 'House' in conf:
                ...
                try:
                    buildname = response.xpath('//*[@id="PropertySummary"]/header/h4/text()').extract_first().split(',')[0].strip()
