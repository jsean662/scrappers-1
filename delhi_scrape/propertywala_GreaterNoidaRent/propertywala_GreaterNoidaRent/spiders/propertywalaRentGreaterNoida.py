# -*- coding: utf-8 -*-
import scrapy
from ..items import PropertywalaGreaternoidarentItem
...
class PropertywalarentgreaternoidaSpider(scrapy.Spider):
    name = "propertywalaRentGreaterNoida"
    allowed_domains = ["propertywala.com"]
    start_urls = [
        'https://www.propertywala.com/properties/type-residential/for-rent/location-greater_noida_uttar_pradesh?page=%s' % page for page in range(1, 13)
    ]
    custom_settings = {
        'DEPTH_LIMIT': 10000,
        'DOWNLOAD_DELAY': 1}
    item = PropertywalaGreaternoidarentItem()
    ...
    def parse1(self, response):
        ...
        if 'plot' in checkprop.lower() or 'land' in checkprop.lower():
            ...
            try:
                ...
                self.item['address'] = 'Greater Noida'
                self.item['locality'] = 'None'

            try:
                buildname = response.xpath('//*[@id="PropertySummary"]/header/h4').extract_first().split(',')[0]
            except:
