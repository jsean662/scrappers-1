import scrapy
import logging
from commonFRentDelhi.items import CommonfrentdelhiItem
...
class CommonfloorrentdelhiSpider(scrapy.Spider):
    name = "commonFloorRentDelhi"
    allowed_domains = ["https://www.commonfloor.com"]
    start_urls = ['https://www.commonfloor.com/listing-search?city=Delhi-NCR&prop_name[]=&property_location_filter[]=&use_pp=0&set_pp=1&polygon=1&page_size=30&search_intent=rent&min_inr=&max_inr=&page=1']
    ...
    def parse(self,response):
        ...
        if curPage < maxPage:
            nexturl = 'https://www.commonfloor.com/listing-search?city=Delhi-NCR&prop_name[]=&property_location_filter[]=&use_pp=0&set_pp=1&polygon=1&page_size=30&search_intent=sale&min_inr=&max_inr=&page={}'.format(str(curPage+1))
    ...
    def parse1(self,response):
        ...
        if 'listing' in str(response.url):
            ...
            try:
                listin = response.xpath('//*[@id="page_container"]/div[2]/div/div/div[1]/div[1]/div[1]/div[2]/div/div/div/div[2]/div[3]/p[2]/@title').extract_first()
                if 'Owner' in listin:
