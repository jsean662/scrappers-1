# -*- coding: utf-8 -*-
import scrapy
from ..items import MakaanDelhisaleItem
...
class MakaansaledelhiSpider(scrapy.Spider):
    name = "Makaan_Delhi"
    allowed_domains = ["https://www.makaan.com"]
    start_urls = [
        'https://www.makaan.com/listings?sortBy=date-desc&listingType=buy&pageType=LISTINGS_PROPERTY_URLS&cityName=Delhi&cityId=6&templateId=MAKAAN_CITY_LISTING_BUY&format=json&page=1',
        'https://www.makaan.com/listings?sortBy=date-desc&listingType=rent&pageType=LISTINGS_PROPERTY_URLS&cityName=Delhi&cityId=6&templateId=MAKAAN_CITY_LISTING_BUY&format=json&page=1',
        'https://www.makaan.com/listings?sortBy=date-desc&listingType=buy&pageType=LISTINGS_PROPERTY_URLS&cityName=Ghaziabad&cityId=8&templateId=MAKAAN_CITY_LISTING_BUY&format=json&page=1',
        'https://www.makaan.com/listings?sortBy=date-desc&listingType=rent&pageType=LISTINGS_PROPERTY_URLS&cityName=Ghaziabad&cityId=8&templateId=MAKAAN_CITY_LISTING_BUY&format=json&page=1',
        'https://www.makaan.com/listings?sortBy=date-desc&listingType=buy&pageType=LISTINGS_PROPERTY_URLS&cityName=Faridabad&cityId=88&templateId=MAKAAN_CITY_LISTING_BUY&format=json&page=1',
        'https://www.makaan.com/listings?sortBy=date-desc&listingType=rent&pageType=LISTINGS_PROPERTY_URLS&cityName=Faridabad&cityId=88&templateId=MAKAAN_CITY_LISTING_BUY&format=json&page=1',
        'https://www.makaan.com/listings?sortBy=date-desc&listingType=buy&pageType=LISTINGS_PROPERTY_URLS&cityName=Noida&cityId=20&templateId=MAKAAN_CITY_LISTING_BUY&format=json&page=1',
        'https://www.makaan.com/listings?sortBy=date-desc&listingType=rent&pageType=LISTINGS_PROPERTY_URLS&cityName=Noida&cityId=20&templateId=MAKAAN_CITY_LISTING_BUY&format=json&page=1',
        'https://www.makaan.com/listings?sortBy=date-desc&listingType=buy&pageType=LISTINGS_PROPERTY_URLS&cityName=Gurgaon&cityId=11&templateId=MAKAAN_CITY_LISTING_BUY&format=json&page=1',
        'https://www.makaan.com/listings?sortBy=date-desc&listingType=rent&pageType=LISTINGS_PROPERTY_URLS&cityName=Gurgaon&cityId=11&templateId=MAKAAN_CITY_LISTING_BUY&format=json&page=1',
        'https://www.makaan.com/listings?sortBy=date-desc&listingType=buy&pageType=LISTINGS_PROPERTY_URLS&cityName=Greater%20Noida&cityId=352&templateId=MAKAAN_CITY_LISTING_BUY&format=json&page=1',
        'https://www.makaan.com/listings?sortBy=date-desc&listingType=rent&pageType=LISTINGS_PROPERTY_URLS&cityName=Greater%20Noida&cityId=352&templateId=MAKAAN_CITY_LISTING_BUY&format=json&page=1',

=======

class MakaansaledelhiSpider(scrapy.Spider):
    name = "makaanSaleDelhi"
    allowed_domains = ["makaan.com"]
    start_urls = [
        'https://www.makaan.com/listings?sortBy=date-desc&listingType=buy&pageType=CITY_URLS&cityName=Delhi&cityId=6&templateId=MAKAAN_CITY_LISTING_BUY&page=1',
...
=======
                ...
                if 'onstruction' in item['Status']:
                    ...
                    item['age'] = i.xpath('.//div[contains(@class,"dcol age")]/div[1]/text()').extract_first(
                        default='0')
...
=======
                ...
                if not item['Building_name'] == 'None' and not item['sublocality'] == 'None' and not item[
                    'locality'] == 'None':
                    item['address'] = item['Building_name'] + ',' + item['sublocality'] + ',' + item['locality'] + ',' + \
                                      item['city']
>>>>>>> ec62c69e8c728b37e8eebf8cc672512203d9567f
...
=======
                if (((not item['Monthly_Rent'] == '0') and (not item['Bua_sqft'] == '0') and (
                ...
                not item['lat'] == '0')) or ((not item['Selling_price'] == '0') and (not item['Bua_sqft'] == '0') and (
                not item['lat'] == '0')) or ((not item['Monthly_Rent'] == '0') and (not item['Bua_sqft'] == '0') and (
                not item['lat'] == '0')) or ((not item['Selling_price'] == '0') and (not item['Bua_sqft'] == '0') and (
                not item['Building_name'] == 'None')) or (
                        (not item['Monthly_Rent'] == '0') and (not item['Bua_sqft'] == '0') and (
...
=======
                ...
                not item['txn_type'] == 'None') and (not item['property_type'] == 'None') and (
                    (not item['Selling_price'] == '0') or (not item['Monthly_Rent'] == '0'))):
                    item['quality1'] = 1
                else:
                    item['quality1'] = 0
                ...
                try:
                    ...
                    if pages is not None:
                        ...
                        totalpages = pages['totalPages']
                        if pageno < totalpages:
                            url = 'https://www.makaan.com/listings?sortBy=date-desc&listingType=buy&pageType=CITY_URLS&cityName=Delhi&cityId=6&templateId=MAKAAN_CITY_LISTING_BUY&page=' + str(pageno+1)
