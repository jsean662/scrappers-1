...
class MakaansaledelhiSpider(scrapy.Spider):
    ...
    start_urls = (
        'https://www.makaan.com/listings?listingType=buy&pageType=LISTINGS_PROPERTY_URLS&cityName=Delhi&cityId=6&templateId=MAKAAN_CITY_LISTING_BUY&page=%s' % page for page in range(1, 1043)
    )
    custom_settings = {
        'DEPTH_LIMIT': 5000,
        'DOWNLOAD_DELAY': 3,
