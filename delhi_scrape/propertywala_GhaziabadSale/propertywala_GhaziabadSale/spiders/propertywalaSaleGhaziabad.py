# -*- coding: utf-8 -*-
import scrapy
from ..items import PropertywalaGhaziabadsaleItem
...
class PropertywalasaleghaziabadSpider(scrapy.Spider):
    name = "propertywalaSaleGhaziabad"
    allowed_domains = ["propertywala.com/"]
    start_urls = [
        'https://www.propertywala.com/properties/type-residential/for-sale/location-ghaziabad_uttar_pradesh?page=%s' % page for page in range(1, 41)
        ]
    custom_settings = {
        'DEPTH_LIMIT': 10000,
        'DOWNLOAD_DELAY': 1}
    item = PropertywalaGhaziabadsaleItem()
