    ...
    def parse1(self, response):
        try:
            ...
            try:
                ...
                build = response.xpath('//div[@id="PropertyDetails"]/section/header/h3/text()').extract_first(default='').strip()
                build1 = response.xpath('//div[@id="PropertyDetails"]/section/header/h4/text()').extract_first(default='').strip()
            except Exception as e:
