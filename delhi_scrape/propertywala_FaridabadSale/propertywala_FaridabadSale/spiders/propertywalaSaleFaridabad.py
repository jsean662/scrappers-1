# -*- coding: utf-8 -*-
import scrapy
from ..items import PropertywalaFaridabadsaleItem
...
class PropertywalasalefaridabadSpider(scrapy.Spider):
    name = "propertywalaSaleFaridabad"
    allowed_domains = ["propertywala.com"]
    start_urls = [
        'https://www.propertywala.com/properties/type-residential/for-sale/location-faridabad_haryana?page=%s' % page for page in range(1, 41)
    ]
    custom_settings = {
        'DEPTH_LIMIT': 10000,
        'DOWNLOAD_DELAY': 1}
    item = PropertywalaFaridabadsaleItem()
