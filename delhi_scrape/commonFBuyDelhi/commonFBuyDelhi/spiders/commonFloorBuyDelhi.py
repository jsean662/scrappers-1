import scrapy
import logging
from commonFBuyDelhi.items import CommonfbuydelhiItem
...
class CommonfloorbuydelhiSpider(scrapy.Spider):
    name = "commonFloorBuyDelhi"
    allowed_domains = ["https://www.commonfloor.com/"]
    start_urls = ['https://www.commonfloor.com/listing-search?city=Delhi-NCR&prop_name[]=&property_location_filter[]=&use_pp=0&set_pp=1&polygon=1&page_size=30&search_intent=sale&min_inr=&max_inr=&page=1']
