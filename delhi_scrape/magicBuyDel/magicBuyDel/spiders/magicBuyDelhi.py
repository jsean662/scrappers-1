import scrapy
from magicBuyDel.items import MagicbuydelItem
...
class MagicbuydelhiSpider(scrapy.Spider):
    ...
    start_urls = [
        'http://www.magicbricks.com/property-for-sale/residential-real-estate?proptype=Multistorey-Apartment,Builder-Floor-Apartment,Penthouse,Studio-Apartment,Residential-House,Villa&cityName=Delhi-NCR/Page-%s' % page for page in range(1, 4305)
    ]
