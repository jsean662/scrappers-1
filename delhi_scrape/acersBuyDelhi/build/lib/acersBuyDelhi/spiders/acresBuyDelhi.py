import scrapy
from acersBuyDelhi.items import AcersbuydelhiItem
...
class AcresbuydelhiSpider(scrapy.Spider):
    name = "acresBuyDelhi"
    allowed_domains = ["http://www.99acres.com/"]
    start_urls = ['http://www.99acres.com/property-in-delhi-ncr-ffid-page-%s?orig_property10_type=1,4,2,90&search_type=QS&search_location=CP12&pageid=QS&keyword_orig=pune&property_type=1,4,2,90' % page for page in xrange(1,3471)]
    custom_settings = {
            'DEPTH_LIMIT': 3000,
            'DOWNLOAD_DELAY': 12
        }
