...
class PropertywalasalenewdelhiSpider(scrapy.Spider):
    name = "propertywalaSaleNewDelhi"
    allowed_domains = ["propertywala.com"]
    start_urls = (
        'https://www.propertywala.com/properties/type-residential/for-sale/location-new_delhi?page=%s' % page for page in range(1, 41)
    )
    custom_settings = {
        'DEPTH_LIMIT': 10000,
        'DOWNLOAD_DELAY': 1}
