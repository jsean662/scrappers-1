...
class AcresrentSpider(CrawlSpider):
	...
	def parse(self,response):
		...
		if curPage < 700:
			next_url = 'http://www.99acres.com/rent-property-in-bangalore-ffid-page-{}?orig_property_type=1,4,2,3,90,22&search_type=QS&search_location=NRI&lstacn=SEARCH&pageid=QS&search_id=9216660749981483&src=PAGING&lastAcn=SEARCH&lastAcnId=9216660749981483&property_type=1,4,2,3,90,22'.format(str(curPage+1))
