...
from ..items import MakaansellItem
import json
import datetime
...
class MakaanSpider(CrawlSpider):
    name = "Makaan_Bangalore"
    
    allowed_domains = ['makaan.com']
    start_urls = [
        'https://www.makaan.com/listings?sortBy=date-desc&listingType=buy&pageType=LISTINGS_PROPERTY_URLS&cityName=Bangalore&cityId=2&templateId=MAKAAN_CITY_LISTING_BUY&format=json&page=1',
        'https://www.makaan.com/listings?sortBy=date-desc&listingType=rent&pageType=LISTINGS_PROPERTY_URLS&cityName=Bangalore&cityId=2&templateId=MAKAAN_CITY_LISTING_BUY&format=json&page=1',
    ]
