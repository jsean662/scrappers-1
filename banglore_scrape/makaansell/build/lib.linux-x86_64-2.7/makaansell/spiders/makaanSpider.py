...
from makaansell.items import MakaansellItem
...
class MakaanSpider(CrawlSpider):
    name = "makaanSpiderBangalore"
    
    allowed_domains = ['makaan.com']
    start_urls = [  
                   "https://www.makaan.com/bangalore-residential-property/buy-property-in-bangalore-city?page=1",
                   "https://www.makaan.com/bangalore-residential-property/rent-property-in-bangalore-city?page=1"
                ]
