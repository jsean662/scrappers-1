...
class MagicrentSpider(scrapy.Spider):
	name = 'magicbricksrentBangalore'
	
	
	allowed_domains = ['magicbricks.com']
	start_urls = ['http://www.magicbricks.com/property-for-rent/residential-real-estate?proptype=Multistorey-Apartment,Builder-Floor-Apartment,Penthouse,Studio-Apartment,Service-Apartment,Residential-House,Villa&cityName=Bangalore/Page-1']
	custom_settings = {
			'DEPTH_LIMIT' : 10000,
			'DOWNLOAD_DELAY': 5
		}
