...
class HousingSpider(scrapy.Spider):
    ...
    start_urls = [
        'https://buy.housing.com//api/v3/buy/index/filter?source=web&poly=d94a0854185332e78d1b&sort_key=date_added&results_per_page=30&placeholder_ids=2,3,6,7&p=1',
    ]
