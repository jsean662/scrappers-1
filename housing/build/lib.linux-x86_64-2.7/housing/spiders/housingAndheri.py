...
class HousingSpider(scrapy.Spider):
    ...
    start_urls = ['https://buy.housing.com/api/v1/buy/index/filter?placeholder_ids=6,2,3,7&sort_key=relevance&poly=2195824f4c8e021d7b8e&results_per_page=20&show_collections=false&show_aggregations=false&np_offset=0&resale_offset=-3&resale_total_count=1883&np_total_count=74&p=1']
    ...
    def parse(self,response):
        ...
        if not last :
            next_url = 'https://buy.housing.com/api/v1/buy/index/filter?placeholder_ids=6,2,3,7&sort_key=relevance&poly=2195824f4c8e021d7b8e&results_per_page=20&show_collections=false&show_aggregations=false&np_offset=0&resale_offset=-3&resale_total_count=1883&np_total_count=74&p=' + str(curValue+1)
