...
class HousingSpider(scrapy.Spider):
    ...
    start_urls = ['https://buy.housing.com/api/v1/buy/index/filter?placeholder_ids=6,2,3,7&sort_key=relevance&poly=33cdee1fbe1a6b6d7578&results_per_page=20&show_collections=true&show_aggregations=true&source=seo&p=1']
    ...
    def parse(self,response):
        ...
        if not last :
            next_url = 'https://buy.housing.com/api/v1/buy/index/filter?placeholder_ids=6,2,3,7&sort_key=relevance&poly=33cdee1fbe1a6b6d7578&results_per_page=20&show_collections=true&show_aggregations=true&source=seo&p=' + str(curValue+1)
