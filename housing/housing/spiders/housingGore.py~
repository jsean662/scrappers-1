...
class HousingSpider(scrapy.Spider):
    ...
    start_urls = ['https://buy.housing.com/api/v1/buy/index/filter?placeholder_ids=6,2,3,7&sort_key=relevance&poly=873732dc30b2ac1801c5&results_per_page=20&show_collections=false&show_aggregations=false&feature_type=housing_region&np_offset=0&resale_offset=-2&resale_total_count=2854&np_total_count=72&p=1']
    ...
    def parse(self,response):
        ...
        if not last :
            next_url = 'https://buy.housing.com/api/v1/buy/index/filter?placeholder_ids=6,2,3,7&sort_key=relevance&poly=873732dc30b2ac1801c5&results_per_page=20&show_collections=false&show_aggregations=false&feature_type=housing_region&np_offset=0&resale_offset=-2&resale_total_count=2854&np_total_count=72&p=' + str(curValue+1)
