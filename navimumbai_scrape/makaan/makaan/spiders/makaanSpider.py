...
class MakaanSpider(CrawlSpider):
    name = "Makaan_Navimumbai"
    
    allowed_domains = ['makaan.com']
    start_urls = [
        'https://www.makaan.com/listings?sortBy=date-desc&listingType=buy&pageType=LISTINGS_PROPERTY_URLS&cityName=Mumbai&suburbName=navi%20mumbai&cityId=18&suburbId=10045&templateId=MAKAAN_SUBURB_LISTING_BUY&format=json&page=1',
        'https://www.makaan.com/listings?sortBy=date-desc&listingType=rent&pageType=LISTINGS_PROPERTY_URLS&cityName=Mumbai&suburbName=navi%20mumbai&cityId=18&suburbId=10045&templateId=MAKAAN_SUBURB_LISTING_BUY&format=json&page=1',
    ]
    custom_settings = {
        'DEPTH_LIMIT': 10000,
        'DOWNLOAD_DELAY': 3,
