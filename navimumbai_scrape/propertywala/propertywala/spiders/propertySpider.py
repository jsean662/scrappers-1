...
class PropWala(CrawlSpider):
    ...
    start_urls = [
        'https://www.propertywala.com/properties/type-residential/for-sale/location-navi_mumbai_maharashtra?orderby=date',
        'https://www.propertywala.com/properties/type-residential/for-rent/location-navi_mumbai_maharashtra?orderby=date',
    ]
