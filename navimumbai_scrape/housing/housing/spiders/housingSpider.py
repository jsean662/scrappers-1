...
class HousingSpider(scrapy.Spider):
    name = 'housingNavimumbai'
    
    allowed_domains = ['housing.com']
    start_urls = ['https://buy.housing.com//api/v3/buy/index/filter?source=web&city_uuid=a0fd32816f73961748cf&poly=32964110855b9736fd94&sort_key=date_added&total=51163&np_total_count=960&resale_total_count=50203&np_offset=0&resale_offset=0&is_last_page=false&project_flat_config_count=2363&negative_aggregation={}&show_collections=true&show_aggregations=true&placeholder_ids=2,3,6,7&p=1']
    ...
    def parse(self,response):
        ...
        if data['is_last_page']==False:
            next_url = 'https://buy.housing.com//api/v3/buy/index/filter?source=web&city_uuid=a0fd32816f73961748cf&poly=32964110855b9736fd94&sort_key=date_added&total=51163&np_total_count=960&resale_total_count=50203&np_offset=0&resale_offset=0&is_last_page=false&project_flat_config_count=2363&negative_aggregation={}&show_collections=true&show_aggregations=true&placeholder_ids=2,3,6,7&p='+str(pageNo+1)
