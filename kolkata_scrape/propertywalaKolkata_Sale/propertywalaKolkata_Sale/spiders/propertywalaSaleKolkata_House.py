...
class PropertywalasalekolkataHouseSpider(scrapy.Spider):
    name = "propertywalaSaleKolkata_House"
    allowed_domains = ["propertywala.com"]
    start_urls = (
        'https://www.propertywala.com/properties/type-residential_independent_house/for-sale/location-kolkata_west_bengal?page=%s' % page for page in range(1, 10)
    )
    custom_settings = {
        'DEPTH_LIMIT': 10000,
        'DOWNLOAD_DELAY': 1
