# -*- coding: utf-8 -*-
import scrapy
from ..items import MakaanKolkatabuyItem
...
class KolkatamakaanBuySpider(scrapy.Spider):
    name = "Makaan_Kolkata"
    allowed_domains = ["makaan.com"]
<<<<<<< HEAD
    start_urls = [
        'https://www.makaan.com/listings?sortBy=date-desc&listingType=buy&pageType=LISTINGS_PROPERTY_URLS&cityName=Kolkata&cityId=16&templateId=MAKAAN_CITY_LISTING_BUY&format=json&page=1',
        'https://www.makaan.com/listings?sortBy=date-desc&listingType=rent&pageType=LISTINGS_PROPERTY_URLS&cityName=Kolkata&cityId=16&templateId=MAKAAN_CITY_LISTING_BUY&format=json&page=1',
    ]
    custom_settings = {
        'DEPTH_LIMIT': 10000,
        'DOWNLOAD_DELAY': 5.0,
=======
    start_urls = (
        'https://www.makaan.com/listings?sortBy=date-desc&listingType=buy&pageType=CITY_URLS&cityName=Kolkata&cityId=16&templateId=MAKAAN_CITY_LISTING_BUY&page=1',
    )
    custom_settings = {
        'DEPTH_LIMIT': 10000,
        'DOWNLOAD_DELAY': 3,
...
=======
                ...
                if 'ale' in item['txn_type']:
                    prc_pr_sf = i.xpath(
                        'div[contains(@class,"cardWrapper")]/div[@class="cardLayout clearfix"]/div[@class="infoWrap"]/div[@class="headInfo"]/div[@class="priceWrap"]/div[@class="price-rate-col"]/div[@class="rate"]/span[@class="val"]/text()').extract_first()
                    item['price_per_sqft'] = re.findall('[0-9]+', prc_pr_sf)
                    item['price_per_sqft'] = ''.join(item['price_per_sqft'])
                else:
                    item['price_per_sqft'] = '0'
                ...
                if 'onstruction' in item['Status']:
                    try:
                        date = i.xpath(
                            'div[contains(@class,"cardWrapper")]/div[@class="cardLayout clearfix"]/div[@class="infoWrap"]/div[@class="highlight-points"]/div[@class="dcol poss"]/div[1]/text()').extract_first()
...
=======
                ...
                try:
                    ...
                    if pages is not None:
                        ...
                        totalpages = pages['totalPages']
                        if pageno < totalpages:
                            url = 'https://www.makaan.com/listings?sortBy=date-desc&listingType=buy&pageType=CITY_URLS&cityName=Kolkata&cityId=16&templateId=MAKAAN_CITY_LISTING_BUY&page=' + str(pageno+1)
