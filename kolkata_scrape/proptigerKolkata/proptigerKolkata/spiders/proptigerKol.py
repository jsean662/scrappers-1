import scrapy
from proptigerKolkata.items import ProptigerkolkataItem
...
class ProptigerkolSpider(scrapy.Spider):
    name = "proptigerKolkata"
    allowed_domains = ["https://www.proptiger.com/"]
    start_urls = [
            'https://www.proptiger.com/app/v2/project-listing?selector={%22filters%22:{%22and%22:[{%22equal%22:{%22cityId%22:16}},{%22equal%22:{%22cityId%22:16}}]},%22paging%22:{%22start%22:0,%22rows%22:2000}}'
            ]
