...
import re
from ..items import PropertywalakolkatarentItem
from datetime import datetime as dt
from dateutil.relativedelta import relativedelta


class PropertywalakolkataRentSpider(scrapy.Spider):
    name = "propertywalaRentKolkata"
    allowed_domains = ["propertywala.com"]
    start_urls = (
        'https://www.propertywala.com/properties/type-residential/for-rent/location-kolkata_west_bengal?page=%s' % page for page in range(1, 30)
    )
    custom_settings = {
        'DEPTH_LIMIT': 10000,
        'DOWNLOAD_DELAY': 1
    }
    item = PropertywalakolkatarentItem()
