import scrapy
import logging
from commonFRentKol.items import CommonfrentkolItem
...
class CommonfloorrentkolkataSpider(scrapy.Spider):
    name = "commonFloorRentKolkata"
    allowed_domains = ["https://www.commonfloor.com"]
    start_urls = ['https://www.commonfloor.com/listing-search?city=Kolkata&prop_name[]=&property_location_filter[]=&use_pp=0&set_pp=1&polygon=1&page_size=30&search_intent=rent&min_inr=&max_inr=&page=1']
