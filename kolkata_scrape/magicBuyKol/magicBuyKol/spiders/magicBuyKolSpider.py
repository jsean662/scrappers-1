    ...
    def parse(self, response):
        try:
            ...
            if 'resultBlockWrapper' in str(response.body):
                ...
                url = 'http://www.magicbricks.com/property-for-sale/residential-real-estate?proptype=Multistorey-Apartment,Builder-Floor-Apartment,Penthouse,Studio-Apartment,Residential-House,Villa&cityName=Kolkata&sortBy=mostRecent/Page-' + str(pageno + 1)
                # print(url)
