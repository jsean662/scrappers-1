...
class MagicbuykolspiderSpider(scrapy.Spider):
    name = "magicbricksBuyPune"
    allowed_domains = ["http://www.magicbricks.com/"]

    start_urls = (
        'http://www.magicbricks.com/property-for-sale/residential-real-estate?proptype=Multistorey-Apartment,Builder-Floor-Apartment,Penthouse,Studio-Apartment,Residential-House,Villa&cityName=Pune/Page-1',  # % page for page in range(1, 2015)
    )
