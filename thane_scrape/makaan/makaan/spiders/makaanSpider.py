...
class MakaanSpider(CrawlSpider):
    ...
    start_urls = [  
                   'https://www.makaan.com/mumbai/thane-property-10048?page=1',
                   'https://www.makaan.com/mumbai/thane-flats-for-rent-10048?page=1'
                ]
    ...
    def parse(self, response):
        ...
        for i in a:
            ...
            self.item['city'] = data['suburbName']
            ...
            if (self.item['Status'] == '' or self.item['Status'] == None):
                self.item['Status'] = 'None'
            if 'ntal' in self.item['txn_type']:
                self.item['Status'] = i.xpath('.//div[@class="dcol furnishstatus"]/div[contains(@class,"val")]/text()').extract_first()
