...
class MakaanSpider(CrawlSpider):
    ...
    start_urls = [
        'https://www.makaan.com/listings?sortBy=date-desc&listingType=buy&pageType=LISTINGS_PROPERTY_URLS&cityName=Mumbai&suburbName=thane&cityId=18&suburbId=10048&templateId=MAKAAN_SUBURB_LISTING_BUY&format=json&page=1',
        'https://www.makaan.com/listings?sortBy=date-desc&listingType=rent&pageType=LISTINGS_PROPERTY_URLS&cityName=Mumbai&suburbName=thane&cityId=18&suburbId=10048&templateId=MAKAAN_SUBURB_LISTING_BUY&format=json&page=1',
    ]
    custom_settings = {
        'DEPTH_LIMIT': 10000,
        'DOWNLOAD_DELAY': 3,
        ...
        for i in a:
            try:
                ...
                try:
                    ...
                    if item['Bua_sqft'] is None or item['Bua_sqft'] == '' or item['Bua_sqft'] == ' ':
                        item['Bua_sqft'] = '0'
                except:
                    item['Bua_sqft'] = '0'
