...
class MagicSpider(scrapy.Spider):
	name = 'magicbrickssellThane'
	allowed_domains = ['magicbricks.com']
	start_urls = ['http://www.magicbricks.com/property-for-sale/residential-real-estate?proptype=Multistorey-Apartment,Builder-Floor-Apartment,Penthouse,Studio-Apartment,Residential-House,Villa&cityName=Thane/Page-1']
	custom_settings = {
			'DEPTH_LIMIT' : 10000,
			'DOWNLOAD_DELAY': 5
		}   
