...
class HousingSpider(scrapy.Spider):
    ...
    start_urls = ['https://buy.housing.com//api/v3/buy/index/filter?source=web&poly=15d8bd7f38429515e1b1&sort_key=date_added&tag_suggestions=true&total=10958&np_total_count=303&resale_total_count=10655&np_offset=0&resale_offset=0&is_last_page=false&project_flat_config_count=867&negative_aggregation={}&show_collections=true&show_aggregations=true&placeholder_ids=2,3,6,7&p=1']
    ...
    def parse(self,response):
        ...
        if data['is_last_page']==False:
            next_url = 'https://buy.housing.com//api/v3/buy/index/filter?source=web&poly=15d8bd7f38429515e1b1&sort_key=date_added&tag_suggestions=true&total=10958&np_total_count=303&resale_total_count=10655&np_offset=0&resale_offset=0&is_last_page=false&project_flat_config_count=867&negative_aggregation={}&show_collections=true&show_aggregations=true&placeholder_ids=2,3,6,7&p='+str(pageNo+1)
