...
class HousingSpider(scrapy.Spider):
    ...
    start_urls = [
        'https://buy.housing.com//api/v3/buy/index/filter?source=web&poly=15d8bd7f38429515e1b1&sort_key=date_added&results_per_page=10&placeholder_ids=2,3,6,7&p=1',
    ]
