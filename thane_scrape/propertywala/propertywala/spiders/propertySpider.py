...
<<<<<<< HEAD
    name = "propertywalaThane"
    allowed_domains = ['propertywala.com']
    start_urls = [
        'https://www.propertywala.com/properties/type-residential/for-sale/location-thane_maharashtra?orderby=date',
        'https://www.propertywala.com/properties/type-residential/for-rent/location-thane_maharashtra?orderby=date',
    ]
...
=======
	...
	allowed_domains = ['propertywala.com']
	start_urls = [ 
		'https://www.propertywala.com/properties/type-residential/for-sale/location-thane_maharashtra',
		'https://www.propertywala.com/properties/type-residential/for-rent/location-thane_maharashtra',
		]      
