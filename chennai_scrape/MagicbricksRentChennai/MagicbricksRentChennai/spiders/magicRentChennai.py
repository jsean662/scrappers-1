...
<<<<<<< HEAD
                    day = dates.xpath('text()').extract_first().strip()
...
<<<<<<< HEAD
        ...
        if pagecount == 0 or pagecount is None:
            if 'resultBlockWrapper' in str(response.body):
                ...
                # 'http://www.magicbricks.com/property-for-rent/residential-real-estate?proptype=Multistorey-Apartment,Builder-Floor-Apartment,Penthouse,Studio-Apartment,Service-Apartment,Residential-House,Villa&cityName=Chennai&sortBy=mostRecent/Page-' + str(pageno + 1)
                # print(url)
...
=======
            ...
            #     if pageNo < pagecount:
            #         url = 'http://www.magicbricks.com/property-for-rent/residential-real-estate?proptype=Multistorey-Apartment,Builder-Floor-Apartment,Penthouse,Studio-Apartment,Service-Apartment,Residential-House,Villa&cityName=Chennai&sortBy=mostRecent/Page-' + str(pageNo + 1)
            #         # print(url)
