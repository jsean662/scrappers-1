# -*- coding: utf-8 -*-
import scrapy
from ..items import MakaanRentchennaiItem
...
class MakaanrentchennaiSpider(scrapy.Spider):
    name = "makaanRentChennai"
    allowed_domains = ["makaan.com"]
    start_urls = [
        'https://www.makaan.com/listings?sortBy=date-desc&listingType=rent&pageType=LISTINGS_PROPERTY_URLS&cityName=Chennai&cityId=5&templateId=MAKAAN_CITY_LISTING_BUY&page=1',
    ]
    custom_settings = {
        'DEPTH_LIMIT': 10000,
        'DOWNLOAD_DELAY': 3,
                ...
                try:
                    ...
                    if pages is not None:
                        ...
                        if pageno < totalpages:
                            url = 'https://www.makaan.com/listings?sortBy=date-desc&listingType=rent&pageType=LISTINGS_PROPERTY_URLS&cityName=Chennai&cityId=5&templateId=MAKAAN_CITY_LISTING_BUY&page=' + str(pageno+1)
