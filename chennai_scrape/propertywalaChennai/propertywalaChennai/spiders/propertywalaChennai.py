# -*- coding: utf-8 -*-
import scrapy
from ..items import PropertywalaSalechennaiItem
...
class PropertywalasalechennaiSpider(scrapy.Spider):
    name = "propertywalaChennai"
    allowed_domains = ["propertywala.com"]
    start_urls = [
        'https://www.propertywala.com/properties/type-residential/for-sale/location-chennai_tamil_nadu?orderby=date',
        'https://www.propertywala.com/properties/type-residential/for-rent/location-chennai_tamil_nadu?orderby=date',
    ]
    custom_settings = {
        'DEPTH_LIMIT': 10000,
        'DOWNLOAD_DELAY': 3.0,
    }
    item = PropertywalaSalechennaiItem()
