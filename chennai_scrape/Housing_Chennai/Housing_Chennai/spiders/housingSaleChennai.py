# -*- coding: utf-8 -*-
import scrapy
from ..items import HousingChennaiItem
...
class HousingsalechennaiSpider(scrapy.Spider):
    name = "housingSaleChennai"
    allowed_domains = ["housing.com"]
    start_urls = [
<<<<<<< HEAD
        'https://buy.housing.com//api/v3/buy/index/filter?source=web&poly=ad008522917b9e167c3b&sort_key=date_added&results_per_page=30&placeholder_ids=2,3,6,7&p=1',
=======
        'https://buy.housing.com//api/v3/buy/index/filter?source=web&poly=9b970b014a2b47e6bdd6&sort_key=date_added&np_offset=0&negative_aggregation={}&show_collections=true&show_aggregations=true&p=1',
        # % page for page in range(1, 1194)
>>>>>>> ec62c69e8c728b37e8eebf8cc672512203d9567f
    ]
    custom_settings = {
        'DEPTH_LIMIT': 10000,
...
=======
            ...
            if data['is_last_page'] == False:
                pageNo = int(response.url.split('&p=')[1])
                next_url = 'https://buy.housing.com//api/v3/buy/index/filter?source=web&poly=11e12081aa78a3375087&sort_key=date_added&np_offset=0&negative_aggregation={}&show_collections=true&p=' + str(pageNo + 1)
