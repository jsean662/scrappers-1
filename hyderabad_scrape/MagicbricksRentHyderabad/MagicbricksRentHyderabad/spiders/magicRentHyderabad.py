    ...
    def parse(self, response):
        ...
        try:
            ...
            if 'resultBlockWrapper' in str(response.body):
                ...
                url = 'http://www.magicbricks.com/property-for-rent/residential-real-estate?proptype=Multistorey-Apartment,Builder-Floor-Apartment,Penthouse,Studio-Apartment,Service-Apartment,Residential-House,Villa&cityName=Hyderabad&sortBy=mostRecent/Page-' + str(pageno + 1)
                # print(url)
