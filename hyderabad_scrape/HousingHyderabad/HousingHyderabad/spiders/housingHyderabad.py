...
import time
from ..items import HousinghyderabadItem
...
class HousinghyderabadSpider(scrapy.Spider):
    ...
    start_urls = (
        'https://buy.housing.com//api/v3/buy/index/filter?source=web&poly=1cdd81323d5286e9fa47&sort_key=date_added&np_offset=0&negative_aggregation={}&show_collections=true&show_aggregations=true&placeholder_ids=2,3,6,7/&p=%s' % page for page in range(1, 745)
    )
    custom_settings = {
        'DEPTH_LIMIT': 5000,
        'DOWNLOAD_DELAY': 3,
