# -*- coding: utf-8 -*-
import scrapy
from ..items import MakaanRenthyderabadItem
import json
import datetime
...
class MakaanrenthyderabadSpider(scrapy.Spider):
    name = "makaanRentHyderabad"
    allowed_domains = ["makaan.com"]
    start_urls = [
        'https://www.makaan.com/listings?sortBy=date-desc&listingType=rent&pageType=LISTINGS_PROPERTY_URLS&cityName=Hyderabad&cityId=12&templateId=MAKAAN_CITY_LISTING_RENT&page=1',
    ]
    custom_settings = {
        'DEPTH_LIMIT': 5000,
        'DOWNLOAD_DELAY': 3,
                ...
                try:
                    ...
                    if pages is not None:
                        ...
                        if pageno < totalpages:
                            url = 'https://www.makaan.com/listings?sortBy=date-desc&listingType=rent&pageType=LISTINGS_PROPERTY_URLS&cityName=Hyderabad&cityId=12&templateId=MAKAAN_CITY_LISTING_RENT&page=' + str(pageno+1)
