# -*- coding: utf-8 -*-
import scrapy
from ..items import PropertywalaSalehyderabadItem
...
class PropertywalasalehyderabadSpider(scrapy.Spider):
    name = "propertywalaHyderabad"
    allowed_domains = ["propertywala.com"]
<<<<<<< HEAD
    start_urls = [
        'https://www.propertywala.com/properties/type-residential/for-sale/location-hyderabad_andhra_pradesh?orderby=date',
        'https://www.propertywala.com/properties/type-residential/for-rent/location-hyderabad_andhra_pradesh?orderby=date',
    ]
=======
    start_urls = (
        'https://www.propertywala.com/properties/type-residential/for-sale/location-hyderabad_andhra_pradesh?orderby=date',
            ...
            # (response.xpath('//section[@id="PropertySummary"]/header/h4/text()').extract_first().strip()).split(',')[0]
                try:
                    try:
                        ...
                        buildname = response.xpath(".//*[@id='PropertyAttributes']/li[contains(text(),'Society')]/span/text()").extract_first().strip()
                except:
                    pass
                if buildname == '' or buildname == ' ' or buildname is None:
                    buildname = address[0]
