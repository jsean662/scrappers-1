import scrapy
from proptigerHydra.items import ProptigerhydraItem
...
class ProptigerhyderabadSpider(scrapy.Spider):
    name = "proptigerHyderabad"
    allowed_domains = ["https://www.proptiger.com/"]
    start_urls = [
            'https://www.proptiger.com/app/v2/project-listing?selector={%22filters%22:{%22and%22:[{%22equal%22:{%22cityId%22:12}},{%22equal%22:{%22cityId%22:12}}]},%22paging%22:{%22start%22:0,%22rows%22:2000}}'
            ]
