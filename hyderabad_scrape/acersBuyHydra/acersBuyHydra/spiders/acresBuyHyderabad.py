import scrapy
from acersBuyHydra.items import AcersbuyhydraItem
...
class AcresbuyhyderabadSpider(scrapy.Spider):
    name = "acresBuyHyderabad"
    allowed_domains = ["99acres.com"]
    start_urls = ['http://www.99acres.com/property-in-hyderabad-ffid-page-%s?orig_property10_type=1,4,2,90&search_type=QS&search_location=CP12&pageid=QS&keyword_orig=pune&property_type=1,4,2,90' % page for page in xrange(1,326)]
    custom_settings = {
            'DEPTH_LIMIT': 3000,
            'DOWNLOAD_DELAY': 12
        }
